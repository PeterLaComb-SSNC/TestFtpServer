...
{
    internal static IHostApplicationBuilder AddServiceDefaults(
    ...
    internal static IHostApplicationBuilder AddDefaultHealthChecks(this IHostApplicationBuilder builder)
    {
